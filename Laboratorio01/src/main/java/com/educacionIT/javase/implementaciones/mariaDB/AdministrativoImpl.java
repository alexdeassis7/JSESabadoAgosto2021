	...
	public List<Administrativo> listar() {
		...
		try {
			...
			while (resultado.next()) {
				...
				Date FechaNacimiento = UtilidadesFecha.getStringAFechaSQL(resultado.getString("FechaNacimiento"));
				Date FechaCargo = UtilidadesFecha.getStringAFechaSQL(resultado.getString("FechaCargo"));
				Float sueldo = resultado.getFloat("sueldo");
